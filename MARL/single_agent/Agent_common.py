...
from .Memory_common import ReplayMemory
from .utils_common import identity
...
class Agent(object):
    ...
    - evaluation: evaluate a learned agent
    """
    ...
    def __init__(self, env, state_dim, action_dim,
        ...
        self.env_state = self._reset_env(self.env)
    ...
    def _step_env(self, env, action):
        ...
        - new gym/gymnasium: step() -> obs, reward, terminated, truncated, info
        """
        out = env.step(action)
    ...
    def _take_one_step(self):
        ...
        next_state, reward, done, _ = self._step_env(self.env, action)
    ...
    def evaluation(self, env, eval_episodes=10):
        ...
        for _ in range(eval_episodes):
            ...
            while not done:
                ...
                state, reward, done, info = self._step_env(env, action)
